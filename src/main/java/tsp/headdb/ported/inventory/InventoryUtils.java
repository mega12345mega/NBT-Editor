...
//                    player.closeInventory();
    ...
    public static void openDatabase() {
        ...
        for (Category category : Category.getValues()) {
            ...
            item.setCustomName(Text.of(Utils.colorize(category.getColor() + "&l" + category.getName().toUpperCase())));
            Lore lore = new Lore(item);
            lore.clearLore();
            lore.addLine(Text.of(Utils.colorize("&e" + HeadAPI.getHeads(category).size() + " heads")));
