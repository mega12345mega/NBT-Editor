...
public class EnchantsTagReference implements TagReference<Enchants, ItemStack> {
	...
	private static TagReference<Enchants, ItemStack> getEnchantsTagRef(String tag, DataComponentType<ItemEnchantmentsComponent> component) {
	...
	private static final TagReference<Enchants, ItemStack> ENCHANTMENTS = getEnchantsTagRef("Enchantments", DataComponentTypes.ENCHANTMENTS);
	private static final TagReference<Enchants, ItemStack> STORED_ENCHANTMENTS = getEnchantsTagRef("StoredEnchantments", DataComponentTypes.STORED_ENCHANTMENTS);
