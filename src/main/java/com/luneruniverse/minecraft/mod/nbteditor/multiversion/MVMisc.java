...
public class MVMisc {
    ...
    public static TexturedButtonWidget newTexturedButton(int x, int y, int width, int height, Identifier image, Identifier hoveredImage, ButtonWidget.PressAction onPress, MVTooltip tooltip) {
        ButtonTextures buttonTextures = new ButtonTextures(image, hoveredImage);
        TexturedButtonWidget output = new TexturedButtonWidget(x, y, width, height, buttonTextures, onPress);
        if (tooltip != null) {
            Version.newSwitch()
    ...
    public static TexturedButtonWidget newTexturedButton(int x, int y, int width, int height, Identifier image, Identifier hoveredImage, ButtonWidget.PressAction onPress) {
        return newTexturedButton(x, y, width, height, image, hoveredImage, onPress, null);
    }
    ...
    public static void setKeyboardRepeatEvents(boolean repeatEvents) {
        Version.newSwitch()
                .range("1.19.3", null, () -> {
                }) // Repeat events are now always on
