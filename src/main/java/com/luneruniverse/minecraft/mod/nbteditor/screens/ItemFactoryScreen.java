...
public class ItemFactoryScreen extends ItemEditorScreen {
	...
	static {
		...
		BASIC_FACTORIES.add(new ItemFactoryReference(TextInst.translatable("nbteditor.container"), ref -> ContainerIO.isContainer(ref.getItem()), ItemsScreen::show));
		...
		addFactory("nbteditor.hide_flags", HideFlagsScreen::new);
	}
