...
public class NBTEditorClient implements ClientModInitializer {
	...
	public static final ScreenHandlerType<ClientChestHandler> CLIENT_CHEST_SCREEN_HANDLER = ScreenHandlerRegistry.registerSimple(new Identifier("nbteditor", "client_chest"), ClientChestHandler::new);
	public static final ScreenHandlerType<ItemsHandler> ITEMS_SCREEN_HANDLER = ScreenHandlerRegistry.registerSimple(new Identifier("nbteditor", "items"), ItemsHandler::new);
	...
	public void onInitializeClient() {
		...
		ScreenRegistry.register(CLIENT_CHEST_SCREEN_HANDLER, ClientChestScreen::new);
		ScreenRegistry.register(ITEMS_SCREEN_HANDLER, ItemsScreen::new);
